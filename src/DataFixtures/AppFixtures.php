...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        $arrayHistory = [
            ...
            "1997" => "Modification de l'appellation de l'association pour devenir l'Association Cultuelle de la Commune d'Ezanville (AMV).",
            ...
            "2015" => "Création de l'Association Cultuelle de la Commune d'Ezanville (AMV) pour la gestion de la mosquée de Ezanville.",
